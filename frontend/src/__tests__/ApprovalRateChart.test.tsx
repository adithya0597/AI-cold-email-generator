...
describe('ApprovalRateChart', () => {
  const sampleData: YearlyData[] = [
    { year: 2020, approvalRate: 0.85, petitions: 100 },
    { year: 2021, approvalRate: 0.88, petitions: 120 },
    { year: 2022, approvalRate: 0.90, petitions: 150 },
    { year: 2023, approvalRate: 0.92, petitions: 180 },
  ...
  it('shows red flag for declining rates', () => {
    const declining: YearlyData[] = [
      { year: 2022, approvalRate: 0.90, petitions: 150 },
      { year: 2023, approvalRate: 0.75, petitions: 120 },
      { year: 2024, approvalRate: 0.55, petitions: 80 },
    ];
